...
export default function Music(props) {
  function addToPlaylist () {
    ...
    const favoritar = (event) => {
      ...
      axios.post('https://projeto-3-tecweb.herokuapp.com/playlist/'+props.title+'/'+props.artist_names+'/'+x+'/', {'title':props.title, 'artist':props.artist_names, 'thumbnail':props.header_image_thumbnail_url, "Access-Control-Allow-Origin":"https://projeto3-tecweb-front.herokuapp.com"})
    }
    return favoritar
  }
  return (
