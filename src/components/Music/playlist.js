...
export default function MusicPlaylist(props) {
  ...
  function deleteFromPlaylist () {
    ...
    const deletar = (event) => {
      ...
      axios.delete('https://projeto-3-tecweb.herokuapp.com/playlist/delete/'+props.song+"/"+props.artist+"/allow-cors", {'song':props.title, 'artist':props.artist_names, 'thumbnail':props.header_image_thumbnail_url},"Access-Control-Allow-Origin: *")
    }
    return deletar
  }
